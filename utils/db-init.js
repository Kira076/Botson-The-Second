 ...
 */
async function getAltFacts(guild) {
    const stmt = {
 ...
 */
async function setAltFacts(guild, pokemon, fact) {
    const factsObject = await getAltFacts(guild);
...
dbHandler.registerTable('poke-alt-facts', stmt1, { getter: getAltFacts, setter: setAltFacts });
